...
for (metric in metrics){
  ...
  ggsave(paste0("images/imbalance_plot_", metric, ".eps"), imbalance_plot)
  ggsave(paste0("images/imbalance_plot_", metric, ".png"), imbalance_plot)
}
```
...
for (metric in metrics){
  ...
  ggsave(paste0("images/dynamic_increasing_plot_", metric, ".eps"), dynamic_increasing_plot)
  ggsave(paste0("images/dynamic_increasing_plot_", metric, ".png"), dynamic_increasing_plot)
}
```
...
for (metric in metrics){
  ...
  ggsave(paste0("images/dynamic_decreasing_plot_", metric, ".eps"), dynamic_decreasing_plot)
  ggsave(paste0("images/dynamic_decreasing_plot_", metric, ".png"), dynamic_decreasing_plot)
}
```
...
for (metric in metrics){
  ...
  ggsave(paste0("images/join_plot_", metric, ".eps"), join_plot, width=7, height=7)
  ggsave(paste0("images/join_plot_", metric, ".png"), join_plot, width=7, height=7)
}
```
...
for (metric in metrics){
  ...
  ggsave(paste0("images/Move_plot_", metric, ".eps"), Move_plot, width=7, height=7)
  ggsave(paste0("images/Move_plot_", metric, ".png"), Move_plot, width=7, height=7)
}
```
...
for (metric in metrics){
  ...
  ggsave(paste0("images/Split_plot_", metric, ".eps"), Split_plot, width=7, height=7)
  ggsave(paste0("images/Split_plot_", metric, ".png"), Split_plot, width=7, height=7)
}
```
