...
for (metric in metrics){
  ...
  df$Algorithm <- ordered(df$Algorithm, levels=c("ESOS-ELM", "OOB", "UOB", "OB", "VFDT"))
  
  imbalance_plot <- ggplot(df, aes(x=Ratio, y=Metric, color=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    geom_point(size=2) + 
    geom_line() + 
    theme_bw() + 
    scale_color_manual(values = c("#FF0000", "#008000", "#0000FF", "#FFA500", "#BF00BF")) + 
  ...
  ggsave(paste0("images/imbalance_plot_", metric, ".eps"), imbalance_plot, width=7, height=7)
...
for (metric in metrics){
  ...
  dynamic_increasing_plot <- ggplot(df, aes(x=ImbalanceDrift, y=Metric, color=Algorithm, group=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Minority ratio drift [%]", y = metric, title="Dynamically increasing minority ratio") + 
    ylim(0.0, 1.0) + 
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
    theme(legend.position = "none", text = element_text(size=20), axis.text.x = element_text(size=10, angle = 45, hjust = 1))
  ggsave(paste0("images/dynamic_increasing_plot_", metric, ".eps"), dynamic_increasing_plot, width=7, height=7)
...
for (metric in metrics){
  ...
  dynamic_decreasing_plot <- ggplot(df, aes(x=ImbalanceDrift, y=Metric, color=Algorithm, group=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Minority ratio drift [%]", y = metric, title="Dynamically decreasing minority ratio") + 
    ylim(0.0, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20), axis.text.x = element_text(size=10, angle = 45, hjust = 1))
  
  ggsave(paste0("images/dynamic_decreasing_plot_", metric, ".eps"), dynamic_decreasing_plot, width=7, height=7)
...
for (metric in metrics){
  ...
  borderline_plot <- ggplot(df, aes(x=Borderline, y=Metric, color=Algorithm, shape=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Borderline examples [%]", y = metric, title="Drifting borderline") + 
    ylim(0.0, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/borderline_plot_", metric, ".eps"), borderline_plot, width=5, height=7)
  ggsave(paste0("images/borderline_plot_", metric, ".png"), borderline_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  borderline_plot <- ggplot(df, aes(x=Borderline, y=Metric, color=Algorithm, shape=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Borderline examples [%]", y = metric, title="Static borderline") + 
    ylim(0.0, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/borderline_plot_", metric, "-post-drift.eps"), borderline_plot, width=5, height=7)
  ggsave(paste0("images/borderline_plot_", metric, "-post-drift.png"), borderline_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  rare_plot <- ggplot(df, aes(x=Rare, y=Metric, color=Algorithm, shape=Algorithm)) + 
    ...
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    labs(x="Rare examples [%]", y = metric, title="Drifting rare") + 
    ylim(0.0, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/rare_plot_", metric, ".eps"), rare_plot, width=5, height=7)
  ggsave(paste0("images/rare_plot_", metric, ".png"), rare_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  rare_plot <- ggplot(df, aes(x=Rare, y=Metric, color=Algorithm, shape=Algorithm)) + 
    ...
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    labs(x="Rare examples [%]", y = metric, title="Static rare") + 
    ylim(0.0, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/rare_plot_", metric, "-post-drift.eps"), rare_plot, width=5, height=7)
  ggsave(paste0("images/rare_plot_", metric, "-post-drift.png"), rare_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  join_plot <-  ggplot(df, aes(x=Join, y=Metric, color=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Sub-cluster joins", y = metric, title="Join") + 
    ylim(0.85, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/join_plot_", metric, ".eps"), join_plot, width=5, height=7)
  ggsave(paste0("images/join_plot_", metric, ".png"), join_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  Move_plot <-  ggplot(df, aes(x=Move, y=Metric, color=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Moving sub-clusters", y = metric, title="Move") + 
    ylim(0.85, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/Move_plot_", metric, ".eps"), Move_plot, width=5, height=7)
  ggsave(paste0("images/Move_plot_", metric, ".png"), Move_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  Split_plot <-  ggplot(df, aes(x=Split, y=Metric, color=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Sub-cluster splits", y = metric, title="Split") + 
    ylim(0.85, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/Split_plot_", metric, ".eps"), Split_plot, width=5, height=7)
  ggsave(paste0("images/Split_plot_", metric, ".png"), Split_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  Split_plot <-  ggplot(df, aes(x=Split, y=Metric, color=Algorithm, shape=Algorithm, linetype=Algorithm)) + 
    ...
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    scale_linetype_manual(values = c("solid", "dashed", "dotdash", "dotted", "twodash")) + 
    labs(x="Sub-clusters", y = metric, title="Static decomposition") + 
    ylim(0.85, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20))
  
  ggsave(paste0("images/Subclusters_plot_", metric, ".eps"), Split_plot, width=5, height=7)
  ggsave(paste0("images/Subclusters_plot_", metric, ".png"), Split_plot, width=5, height=7)
}
```
...
for (metric in metrics){
  ...
  pair_plot <-  ggplot(df, aes(x=Metric, y=reorder(Experiment, -Metric), color=Algorithm, shape=Algorithm)) + 
    ...
    scale_color_manual(values = c("#FF0000", "#008000", "#0000FF", "#FFA500", "#BF00BF")) + 
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    labs(x=metric, y = "Experiment", title="Pairs") + 
    xlim(0.0, 1.0) + 
...
for (metric in metrics){
  ...
  complex_plot <-  ggplot(df, aes(x=Metric, y=reorder(Experiment, -Metric), color=Algorithm, shape=Algorithm)) + 
    ...
    scale_color_manual(values = c("#FF0000", "#008000", "#0000FF", "#FFA500", "#BF00BF")) + 
    scale_shape_manual(values = c(16, 15, 17, 11, 4)) + 
    labs(x=metric, y = "Experiment", title="Complex scenarios") + 
    xlim(0.0, 1.0) + 
    theme(legend.position = "none", text = element_text(size=20), axis.text.y = element_text(size=16))
